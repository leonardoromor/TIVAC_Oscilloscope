...
TIVAWARE_PATH = /home/deathquasar/Projects/DevBoards/TI/TM4C123G/tivaware
...
LDFLAGS += -L$(TIVAWARE_PATH)/driverlib/gcc -ldriver #This add the driverlib to the code during the linker phase
